...
void EMStepScoreSupport(deltai, pNparm, Y, Xvec, ZallVec,Zallnr,Zallnc, pN, pM, pNcov, pNiter, ptol,ptolMaxstep,
...

{
  ...
  *ret_rc = 1;
  ...
  Ncov    = Ncov0 + 1;  /* Allow for intercept */
    ...
    Inv, w_y, W,beta,
    missing_Mat,DEBUG,Info,Info_obs_inv,missing_number,WX,WXZ);
